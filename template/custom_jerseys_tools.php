...
<div id ="wrapper_custom_jerseys" >
	...
	<nav>
		...
		<hgroup>		
			<a onclick="javascript:pasarAStep(2,this);return false;">
				<h2>3</h2>
				<h3>CHECK OUT</h3>
			</a>
			
			<a onclick="javascript:pasarAStep(1, this);return false;">
				<h2>2</h2>
				<h3>DESIGN JERSEY</h3>
			</a>
			
			<a onclick="javascript:pasarAStep(0, this);return false;" class="activo">
				<h2>1</h2>
