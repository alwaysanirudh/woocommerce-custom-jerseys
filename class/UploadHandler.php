...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null, $current_file = null) {
        $upload_array = wp_upload_dir();
        $this->options = array(
            'script_url' => admin_url('admin-ajax.php'),
            'upload_dir' => $upload_array['basedir'] . '/files_temp' . '/' . $current_file . '/',
            'upload_url' => $upload_array['baseurl'] . '/files_temp' . '/' . $current_file . '/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
            ...
            'inline_file_types' => '/\.(eps|jpe?g|ai|pdf)$/i',
            ...
            'image_file_types' => '/\.(eps|jpe?g|ai|pdf)$/i',
